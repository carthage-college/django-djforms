# Django settings for reserveforms project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # ('ngromiuk', 'ngromiuk@carthage.edu'),
)

MANAGERS = ADMINS

DATABASE_ENGINE = 'sqlite3'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'c:/djangoprojects/djforms/formsdb.db'             # Or path to database file if using sqlite3.
