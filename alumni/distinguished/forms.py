...
NOMINATED_FOR =  [
    ...
    ('Distinguished Alumni Service Award ', 'Distinguished Alumni Service Award '),
]
...
class NomineeForm(forms.Form):
    ...
    nominated   = forms.TypedChoiceField(label="Nominated For", choices=NOMINATED_FOR, widget=forms.RadioSelect())
    description = forms.CharField(label="Information Background on Nominee", widget=forms.Textarea)
