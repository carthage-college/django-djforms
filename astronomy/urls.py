...
urlpatterns = patterns('djforms.astronomy',
    ...
    url(r'^institute/evnaluation/success/$', direct_to_template, {'template': 'astronomy/institute/evaluation_done.html'}),
    url(r'^institute/evaluation/$', 'institute.views.evaluation', name='evaluation'),
)
