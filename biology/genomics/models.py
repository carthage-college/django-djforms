...
class PhageHunter(GenericContact):
    ...
    act_comp                    = models.CharField("ACT Composite", max_length=2, null=True, blank=True)
    act_math                    = models.CharField("ACT Math", max_length=2, null=True, blank=True)
    act_science                 = models.CharField("ACT Science Reasoning", max_length=2, null=True, blank=True)
    sat_comp                    = models.CharField("SAT Composite", max_length=4, null=True, blank=True)
    sat_math                    = models.CharField("SAT Math", max_length=3, null=True, blank=True)
    sat_read                    = models.CharField("SAT Critical Reading", max_length=3, null=True, blank=True)
