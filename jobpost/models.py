...
class Post(models.Model):
    ...
    address             = models.CharField('Address', help_text="Use the campus building name here if the job is on campus.")
    city                = models.CharField('City', default="Kenosha")
    state               = models.CharField('State', default="Wisconsin")
