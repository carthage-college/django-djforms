...
from djforms.polisci.wipcs.registration.forms import RegistrationContactForm
from djforms.polisci.wipcs.registration.forms import RegistrationOrderForm
...
def form(request):
    ...
    return render_to_response(
        'polisci/wipcs/registration/form.html', {
