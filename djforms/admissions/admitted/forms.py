...
class ChanceForm(forms.ModelForm):
    ...
    gpa_scale = forms.TypedChoiceField(
        label="GPA Scale",
        choices=GPA_SCALE,
        widget=forms.Select())
    ...
    prospect_status = forms.CharField(
    ...
    class Meta:
        model       = Candidate
        fields      = (
            'first_name','email','confirm_email','status','act_sat',
            'gpa','gpa_scale','information','prospect_status'
        )
