...
class ApplicationProfile(models.Model):
    ...
    organizations = models.TextField(
        ...
        help_text = """
            Please list above all campus activities and organization with
            which you are involved. Also list any positions you currently hold,
            and the number of years you have been involved with
            each organization.
        """
    )
    ...
    why_orientation_leader = models.TextField(
        "Leadership Acumen",
        help_text = """
            What do you believe are the qualities of an effective leader?
        """
    )
    describe_experience = models.TextField(
        "Leadership Experience",
        help_text="""
            Describe an experience that, for you, demonstrates what leadership
