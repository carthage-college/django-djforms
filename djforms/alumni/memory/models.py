...
class Questionnaire(GenericContact):
    ...
    address2 = models.CharField("Address 2", max_length=255)
    city = models.CharField(max_length=128)
    state = USStateField()
    postal_code = models.CharField("Zip code", max_length=10)
    class_year = models.CharField("Your class year", max_length=4)
    ...
    greek_parent = models.CharField(max_length=255, null=True, blank=True)
    greek_siblings = models.TextField(null=True, blank=True)
