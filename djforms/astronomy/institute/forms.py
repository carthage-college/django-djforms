...
class EvaluationForm(forms.Form):
    ...
    programs_activity   = forms.CharField(label = "List programs", help_text = "If yes, please list the programs and/or activities.", max_length=255, required=False)
    ...
    other_experience    = forms.CharField(label = "Other", help_text = "If other, please list them.", max_length=255, required=False)
    ...
    knowledge_comments  = forms.CharField (label  = "Please elaborate", widget=forms.Textarea, required=False)
