...
class ModelUnitedNationsRegistrationForm(forms.Form):
    ...
    home_phone          = USPhoneNumberField(help_text="Format: XXX-XXX-XXXX")
    ...
    comments            = forms.CharField(label="Questions/Comments", help_text="Feel free to list alternate countries in the space below (include your choice and delegation number)", widget=forms.Textarea)
